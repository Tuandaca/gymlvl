...
// 1. Environment
 ...
 int? get age; String? get gender; double? get heightCm; double? get weightKg;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,environment,const DeepCollectionEquality().hash(goals),className,experienceLevel,age,gender,heightCm,weightKg);

@override
String toString() {
  return 'UserProfileDraft(environment: $environment, goals: $goals, className: $className, experienceLevel: $experienceLevel, age: $age, gender: $gender, heightCm: $heightCm, weightKg: $weightKg)';
}
...
@useResult
$Res call({
 String? environment, List<String> goals, String? className, String? experienceLevel, int? age, String? gender, double? heightCm, double? weightKg
});
...
/// Create a copy of UserProfileDraft
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? environment = freezed,Object? goals = null,Object? className = freezed,Object? experienceLevel = freezed,Object? age = freezed,Object? gender = freezed,Object? heightCm = freezed,Object? weightKg = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? environment,  List<String> goals,  String? className,  String? experienceLevel,  int? age,  String? gender,  double? heightCm,  double? weightKg)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfileDraft() when $default != null:
return $default(_that.environment,_that.goals,_that.className,_that.experienceLevel,_that.age,_that.gender,_that.heightCm,_that.weightKg);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? environment,  List<String> goals,  String? className,  String? experienceLevel,  int? age,  String? gender,  double? heightCm,  double? weightKg)  $default,) {final _that = this;
switch (_that) {
case _UserProfileDraft():
return $default(_that.environment,_that.goals,_that.className,_that.experienceLevel,_that.age,_that.gender,_that.heightCm,_that.weightKg);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? environment,  List<String> goals,  String? className,  String? experienceLevel,  int? age,  String? gender,  double? heightCm,  double? weightKg)?  $default,) {final _that = this;
switch (_that) {
case _UserProfileDraft() when $default != null:
return $default(_that.environment,_that.goals,_that.className,_that.experienceLevel,_that.age,_that.gender,_that.heightCm,_that.weightKg);case _:
  return null;
...
class _UserProfileDraft implements UserProfileDraft {
  const _UserProfileDraft({this.environment, final  List<String> goals = const [], this.className, this.experienceLevel, this.age, this.gender, this.heightCm, this.weightKg}): _goals = goals;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,environment,const DeepCollectionEquality().hash(_goals),className,experienceLevel,age,gender,heightCm,weightKg);
...
/// Create a copy of UserProfileDraft
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? environment = freezed,Object? goals = null,Object? className = freezed,Object? experienceLevel = freezed,Object? age = freezed,Object? gender = freezed,Object? heightCm = freezed,Object? weightKg = freezed,}) {
